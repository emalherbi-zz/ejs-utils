...
description : |
  ...
  &lt; input type="text" class="form-control" id="maskDateBr" value="" onkeydown="Util.mask.exec(this, Util.mask.dateBr)" maxlength="10" &gt;</code></pre>
    </div>
  </div>  
  ...
  # Or add the Mask on Input Field
  &lt; input type="text" class="form-control" id="maskHour" value="" onkeydown="Util.mask.exec(this, Util.mask.hour)" maxlength="5" &gt;</code></pre>
    </div>
  </div>  
  ...
  # Or add the Mask on Input Field
  &lt; input type="text" class="form-control" id="maskTelBr" value="" onkeydown="Util.mask.exec(this, Util.mask.telBr)" maxlength="17" &gt;</code></pre>
    </div>
  </div>  
  ...
  # Or add the Mask on Input Field
  &lt; input type="text" class="form-control" id="maskCEP" value="" onkeydown="Util.mask.exec(this, Util.mask.cep)" maxlength="11" &gt;</code></pre>
    </div>
  </div>  
