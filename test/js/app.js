...
test('Util.date.removeDaysBr', function () {
  var input = Util.date.removeDaysBr('24/02/2015', '2'),
  expected = '22/02/2015';
...
test('Util.date.removeMonthBr', function () {
  var input = Util.date.removeMonthBr('24/04/2015', '2'),
  expected = '24/02/2015';
...
test('Util.date.removeYearBr', function () {
  var input = Util.date.removeYearBr('24/01/2017', '2'),
  expected = '24/01/2015';
...
test('Util.date.removeDays', function () {
  var input = Util.date.removeDays('2015-02-24', '2'),
  expected = '2015-02-22';
...
test('Util.date.removeMonth', function () {
  var input = Util.date.removeMonth('2015-04-24', '2'),
  expected = '2015-02-24';
...
test('Util.date.removeYear', function () {
  var input = Util.date.removeYear('2015-02-24', '2'),
  expected = '2013-02-24';

  equal(input, expected, 'This should work with no problem.');
});
test('Util.date.getYearsArray', function () {
  var input = Util.date.getYearsArray('2010', '2020'),
  expected = [2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020];

  deepEqual(input, expected, 'This should work with no problem.');
});
